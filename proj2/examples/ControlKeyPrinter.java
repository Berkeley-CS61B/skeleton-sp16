...
public class ControlKeyPrinter extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // of the window displayed.  Make a tiny window here since we're not going to display anything.
        int windowWidth = 20;
        int windowHeight = 20;
        Scene scene = new Scene(root, windowWidth, windowHeight, Color.WHITE);

        // Register the event handler to be called for all KEY_PRESSED events (the KEY_TYPED events don't work well
        // for the control key, because the character typed is empty (and the KeyCode isn't set for KEY_TYPED events).
