...
public class ScrollBarExample extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        int imageMaxHeight = windowHeight;
        ...
        // Set the position of Josh to be in the middle of the usable screen.  A rectangle's position describes the
        // top left, so we need to subtract half of the width of the image to determine the position of the left side.
        ...
        scrollBar.valueProperty().addListener(new ChangeListener<Number>() {
            public void changed(ObservableValue<? extends Number> observableValue, Number oldValue, Number newValue) {
                // newValue describes the value of the new position of the scroll bar. The numerical value of the
                // position is based on the position of the scroll bar, and on the min and max we set above. For
                // example, if the scroll bar is exactly in the middle of the scroll area, the position will be:
                //      scroll minimum + (scroll maximum - scroll minimum) / 2
                // Here, we can directly use the value of the scroll bar to set the height of Josh, because of how we
                // set the minimum and maximum above.
